...
class Cliente extends Model
{
    ...
    {
        $sql = "SELECT venta_servicio.id, venta_servicio.p_s AS p_s, producto.pro_serv AS servicio, cliente.nombre, cliente.email, venta_servicio.fecha, venta_servicio.vence, venta_servicio.couch, venta_servicio.fperso, venta_servicio.finperso, empleado.nombre AS registro FROM venta_servicio
